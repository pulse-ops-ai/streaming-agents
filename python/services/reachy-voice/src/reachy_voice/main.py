...
from reachy_voice.config import AUDIO_INPUT_DEVICE
...
def _test_mic() -> None:
    ...
    from reachy_voice.audio_capture import AudioCapture, find_device
    from reachy_voice.audio_playback import AudioPlayer

    device = find_device(AUDIO_INPUT_DEVICE, "input") if AUDIO_INPUT_DEVICE else None
...
def _run_loop(press_to_talk: bool) -> None:
    ...
    input_device = find_device(AUDIO_INPUT_DEVICE, "input") if AUDIO_INPUT_DEVICE else None
